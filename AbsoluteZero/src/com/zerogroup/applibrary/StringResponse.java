...
/**
 * This class operates on a given string.
 * Its aim is to find a given pattern inside
 * the string (a "trigger") and to return
 * a pre-defined String as a "response".
 * 
 * @author Giac
 * @version 1.0
 */
...
public class StringResponse {
	...
	/**
	 * Constructor method
	 * @param aString the String on which the class will operate
	 */
	...
	/**
	 * Finds the strings saved as "triggers"
	...
	/**
	 * Adds a new trigger-response pattern that
	 * will be used by findResponse() method
	 * @param trigger the key string
	 * @param response the response that will be sent when the trigger is found in myString
	 * @return the value of the previous response related to the trigger (if present)
	 */
	...
	/**
	 * Checks if the trigger is already present
	 * as an option
	 * @param trigger
	...
	/**
	 * Removes the trigger-response pattern specified
	 * by the trigger
	 * @param trigger of the pattern that needs to be removed
